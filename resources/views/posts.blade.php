  ...
  @if ($posts->count())
    <div class="card mb-3">
      ...
      <div class="card-body text-center">
        <h3 class="card-title">
          <a class="text-decoration-none link-dark" href="/posts/{{ $posts[0]->slug }}">{{ $posts[0]->title }}</a>
        </h3>
        <p>
        ...
        @foreach ($posts->skip(1) as $post)
          ...
          <div class="col-md-4 mb-3">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">
                  <a class="text-decoration-none link-dark" href="/posts/{{ $post->slug }}">{{ $post->title }}</a>
                </h5>
                <p>
                  <small class="text-muted">
